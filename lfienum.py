...
if len(sys.argv) == 2:
	...
	try:
     	   	## windows scan & enum BLIND FIXED NOT TESTED YEY
...
# url + pid args FIXED BUT NOT REVISED
try:
	if sys.argv[2] == "--pid":
...
# url + wrapper + wrapper file arg    ++ handling arg len errors NOT REVISED OR FIXED
try:
